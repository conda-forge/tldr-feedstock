...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tldr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13528&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tldr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tldr` can be installed with:

```
conda install tldr
```

It is possible to list all of the versions of `tldr` available on your platform with:
